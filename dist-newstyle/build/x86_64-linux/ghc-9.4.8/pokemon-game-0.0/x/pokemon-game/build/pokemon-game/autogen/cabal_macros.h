...
/* package fudgets-0.18.4 */
#ifndef VERSION_fudgets
#define VERSION_fudgets "0.18.4"
#endif /* VERSION_fudgets */
#ifndef MIN_VERSION_fudgets
#define MIN_VERSION_fudgets(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  18 || \
  (major1) == 0 && (major2) == 18 && (minor) <= 4)
#endif /* MIN_VERSION_fudgets */
